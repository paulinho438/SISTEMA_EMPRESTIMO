...
<head>
    ...
    <script type="text/javascript" src="../assets/bootstrap/js/script-carne.js"></script>
        ...
        <div class="mb-5">
			<div class="row">
				...
				<div class="col-6 d-flex align-items-start justify-content-start">
					...
					<h2 class="mt-3 ms-3">Carnê</h2>
				</div>
			</div>
		</div>
        <div class="row">
            <div class="col-lg-9">
                <form id="form" method="POST" action="emitir_carne.php" class="">
					<div class="row">
						<div class="col-lg-3 mt-5 info-body-cartao">
                        ...
                        <div class="col-lg-3 mt-5 info-body-cartao">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="email" class="form-control mt-1 custom-input" id="email" placeholder="Email">
                            </div>
                        ...
                        <div class="col-lg-3 mt-5 info-body-cartao">
                            ...
                            <div class="form-group mt-3 mb-4">
                                ...
                                <input required type="text" class="form-control mt-1 custom-input" id="vencimento" placeholder="Data de vencimento">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">Número de parcelas: (<em class="atributo">repeats</em>) <br><strong class="ex">Ex: 5 (int)</strong></label>
                                <select required id="repeticoes" class="form-select mt-1 custom-input">
                                    <?php for ($i = 1; $i < 24; $i++) : ?>
                                        <option><?= $i ?></option>
                                    <?php endfor; ?>
                                </select>
                        ...
                        <div class="col-lg-3 mt-5 info-body-cartao">
                            <h4><strong>Instruções (opcional)</strong></h4>
                            <div class="form-group mt-3 mb-4">
                                ...
                                <input required type="text" class="form-control mt-1 custom-input" id="instrucao1" placeholder="Instrução 1">
                            </div>
                            ...
                            <div class="form-group mt-3 mb-4">
                                ...
                                <input required type="text" class="form-control mt-1 custom-input" id="instrucao2" placeholder="Instrução 2">
                            </div>
                            ...
                            <div class="form-group mt-3 mb-4">
                                ...
                                <input required type="text" class="form-control mt-1 custom-input" id="instrucao3" placeholder="Instrução 3">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control mt-1 custom-input" id="instrucao4" placeholder="Instrução 4">
                            </div>
                ...
                <div class="col-lg-12 mt-5">
                        <button id="btn_emitir_boleto" type="button" class="btn btn-efi-blue icon-success">Emitir carnê <img src="../assets/img/ok-mark.png"></button>
                </div>
            </div>
            ...
            <div class="col-lg-3">
				...
				<div class="col-lg-12 mt-5">
					<a href="../download/exemplo-carne.zip" class="btn btn-efi"><svg class="icon-download"></svg> Baixar este exemplo </a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Nº do carnê</th>
                                            <th>Status</th>
                                            <th>Link responsivo do carnê</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>

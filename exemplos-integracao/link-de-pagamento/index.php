...
<head>
    ...
    <script type="text/javascript" src="../assets/bootstrap/js/scripts_link_pag.js"></script>
...
<body>
		...
		<div class="mb-5">
			<div class="row">
				...
				<div class="col-6 d-flex align-items-start justify-content-start">
					...
					<h2 class="mt-3 ms-3">Link de Pagamento</h2>
				</div>
			</div>
		</div>
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mt-5 info-body">
                            ...
                            <div class="form-group mb-4">
                                <input required type="text" class="form-control mt-1 custom-input" id="message" placeholder="Mensagem para o cliente">
                            </div>

                            <div class="form-group mt-3 mb-4">
                                <label for="exampleInputPassword1">Endereço de Entrega: (<em class="atributo">request_delivery_address</em>) <br><strong class="ex">Solicitar endereço de entrega ao pagador? (informe 'true' para SIM ou 'false' para NÃO) </strong> </label>
                                <select id="request" class="form-select mt-1 custom-input" required>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Métodos de pagamento disponíveis para o pagador: (<em class="atributo">payment_method</em>)<br><strong class="ex">Ex: boleto e cartão (all) | boleto (banking_billet) | cartão (credit_card)</strong></label>
                                <select id="method" class="form-select mt-1 custom-input" required>
                                    <option value="" selected>Selecione a forma de pagamento</option>
                                    <option value="all">boleto e cartão</option>
                                    <option value="banking_billet">boleto</option>
                        ...
                        <div class="col-lg-4 mt-5 info-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Data de vencimento: (<em class="atributo">expire_at</em>) <br><strong class="ex">Ex: 2023-12-15 (yyyy-mm-dd)</strong></label>
                                <input required type="text" class="form-control mt-1 custom-input mb-1" id="vencimento" placeholder="Data de vencimento">
                                ...
                                <br>
                                <em class="atributo"><b>Obs 2:</b> Descontos também podem ser concedidos, de acordo com a forma de pagamento escolhida pelo pagador. Caso deseje utilizar, <a href="https://dev.efipay.com.br//link-pagamento-criando#section-2-criando-um-link-de-pagamento" target="_blank">consulte a documentação</a>.</em>
                            </div>
                ...
                <div class="col-lg-12 mt-5">
                    <button id="btn_emitir_link" type="button" class="btn btn-efi-blue icon-success">Criar Link Pagamento <img src="../assets/img/ok-mark.png"></button>
                </div>
            </div>
            ...
            <div style="margin-top: 45px;" class="col-lg-12 content-guidelines">
				...
				<div class="col-lg-12 mt-5">
					<a href="../download/exemplo-link-de-pagamento.zip" class="btn btn-efi"><svg class="icon-download"></svg> Baixar este exemplo </a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="myModalResult" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"> 
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Retorno da criação do Link de pagamento</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">

...
<head>
    ...
    <script type="text/javascript" src="../assets/bootstrap/js/script-boleto.js"></script>
    	...
    	<div class="row">
            <div class="col-lg-9">
					...
					<div class="row">
						<div class="col-lg-4 mt-5 info-body">
							...
							<div class="form-group">
                                <label for="exampleInputPassword1">Quantidade de itens: (<em class="atributo">amount</em>)<br><strong class="ex">Ex: 1</strong></label>
				...
				<div class="col-lg-12 mt-5">
					<button id="btn_emitir_boleto" type="button" class="btn btn-efi-blue icon-success">Emitir Boleto <img src="../assets/img/ok-mark.png"></button>
				</div>
            </div>
            ...
            <div class="col-lg-3">
				...
				<div class="col-lg-12 mt-5">
					<a href="../download/exemplo-boleto.zip" class="btn btn-efi"><svg class="icon-download"></svg> Baixar este exemplo </a>
                </div>
            </div>
        </div>
	</div>

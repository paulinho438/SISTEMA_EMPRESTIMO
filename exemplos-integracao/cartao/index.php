...
<head>
    ...
    <script type="text/javascript" src="../assets/bootstrap/js/script-cartao.js"></script>
	...
	<div class="container-fluid content">
		<div class="mb-5">
			<div class="row">
				...
				<div class="col-6 d-flex align-items-start justify-content-start">
					...
					<h2 class="mt-3 ms-3">Cartão de crédito</h2>
				</div>
			</div>
		</div>
    	...
    	<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-3 mt-5 info-body-cartao">
                            ...
                            <div class="form-group">
								...
								<input required type="text" class="form-control mt-1 custom-input" id="nascimento" placeholder="Data de nascimento">
							</div>
						...
						<div class="col-lg-3 mt-5 info-body-cartao">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Bandeira: (<em class="atributo">brand</em>) <br><strong class="ex">Ex: Visa</strong></label>
            ...
            <div class="col-lg-3">
				...
				<div class="col-lg-12 mt-5">
					<a href="../download/exemplo-cartao.zip" class="btn btn-efi"><svg class="icon-download"></svg> Baixar este exemplo </a>
                </div>
            </div>
        </div>
	</div>

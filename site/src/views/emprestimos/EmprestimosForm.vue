            ...
            <template #content>
                <div class="col-12">
                    <div class="p-fluid formgrid grid">
                        ...
                        <div class="field col-12 md:col-3">
                            <label for="firstname2">Data Lançamento</label>
                            <Calendar dateFormat="dd/mm/yy" v-tooltip.left="'Selecione a data de Inicio'" v-model="client.dt_lancamento" showIcon :showOnFocus="false" class="" />
                        </div>
                        <!-- <div class="field col-12 md:col-3">
                        ...
                        <div class="field col-12 md:col-3">
                            ...
                            <InputNumber
                                id="inputnumber"
                                disabled="true"
                                :modelValue="client?.lucro"
                                v-model="client.lucro"
                                :mode="'currency'"
                                :currency="'BRL'"
                                :locale="'pt-BR'"
                                :precision="2"
                ...
                <EmprestimoAdd
                    ...
                    v-if="true"
                />
                <AddressClient :address="this.parcelas" :oldCicom="this.oldClient" :loading="loading" @updateCicom="clearCicom" @addCityBeforeSave="addCityBeforeSave" @changeLoading="changeLoading" v-if="true" />
            </template>
        </Card>
    </div>
</template>

...
export default {
    ...
    methods: {
        ...
        gerarParcelas() {
            ...
            console.log('Debug lucro_real:', {
                numParcelas,
                lucroTotal,
                lucroPorParcela,
                emprestimoLucro: this.emprestimo.lucro,
                emprestimoValorTotal: this.emprestimo.valortotal,
                emprestimoValor: this.emprestimo.valor,
                emprestimoMensalidade: this.emprestimo.mensalidade
            });

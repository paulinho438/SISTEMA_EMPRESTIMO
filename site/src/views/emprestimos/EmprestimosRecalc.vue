...
<template>
    ...
    <div class="grid flex flex-wrap mb-3 px-4 pt-2">
        <div class="col-12 px-0 py-0 text-right">
            <Button label="Refinanciar Empréstimo" class="p-button-sm p-button-success" :icon="icons.PLUS" @click="visibleRight = true" />
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="p-fluid formgrid grid">
                <div class="field col-12 md:col-12">
                    ...
                    <Calendar dateFormat="dd/mm/yy" v-tooltip.left="'Selecione a data de Inicio'" v-model="emprestimo.dt_lancamento" showIcon :showOnFocus="false" class="" />
                </div>
            </div>
            <div class="p-fluid formgrid grid">
                <div class="field col-12 md:col-12">

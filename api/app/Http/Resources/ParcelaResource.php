...
class ParcelaResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "venc_real" => Carbon::parse($this->venc_real, 'UTC')->setTimezone('America/Sao_Paulo')->format('d/m/Y'),
            "dt_lancamento" => Carbon::parse($this->dt_lancamento, 'UTC')->setTimezone('America/Sao_Paulo')->format('d/m/Y'),

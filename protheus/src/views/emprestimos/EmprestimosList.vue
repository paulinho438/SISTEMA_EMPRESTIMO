					...
					<template #header>
						...
						<Column field="saldo" header="Saldo a Receber" :sortable="true" class="w-1">
							<template #body="slotProps">
								...
								{{ (slotProps.data.saldoareceber - slotProps.data.saldo_total_parcelas_pagas ).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}
						...
						<Column field="saldo_total_parcelas_pagas" header="Valor Pago" :sortable="true" class="w-1">
							<template #body="slotProps">
								...
								{{ slotProps.data.saldo_total_parcelas_pagas.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}
						...
						<Column field="name" header="Parcelas Pagas" :sortable="false" class="w-1">
							<template #body="slotProps">
								...
								{{ `${slotProps.data.parcelas_pagas.length.toString().padStart(3, '0')} / ${slotProps.data.parcelas.length.toString().padStart(3, '0')}` }}
							</template>
						</Column>

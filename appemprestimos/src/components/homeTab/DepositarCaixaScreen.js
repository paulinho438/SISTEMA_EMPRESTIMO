...
import TopUpDepositarCaixa from '../modals/TopUpDepositarCaixa';
...
export default function DepositarCaixaScreen({navigation}) {
  ...
  return (
    <SafeAreaView style={localStyles.main}>
      <KeyBoardAvoidWrapper contentContainerStyle={localStyles.keyboardType}>
        <View>
          <CHeader color={colors.black} title={'Depositar na Wallet'} />
      ...
      <TopUpDepositarCaixa sheetRef={successRef} dados={valores.banco} />
    </SafeAreaView>
  );
}

...
import TopUpSaqueCaixa from '../modals/TopUpSaqueCaixa';
...
export default function SacarCaixaScreen({navigation}) {
  ...
  return (
    <SafeAreaView style={localStyles.main}>
      <KeyBoardAvoidWrapper contentContainerStyle={localStyles.keyboardType}>
        <View>
          <CHeader color={colors.black} title={'Realizar Saque'} />
      ...
      <TopUpSaqueCaixa sheetRef={successRef} dados={valores.banco} />
    </SafeAreaView>
  );
}
